...
class MessagingHub extends StatelessWidget {
  ...
  // ignore: non_constant_identifier_names
  final Map<String, String> list_of_people = {
    ...
    return Scaffold(
        bottomNavigationBar: NavigationBar(destinations: const [
          NavigationDestination(
              icon: Icon(Icons.check), label: "recent Connections"),
          NavigationDestination(
              icon: Icon(Icons.people), label: "PeopleOfHouston")
        ]),
        body: (ListView.builder(
          itemCount: list_of_people.length,
                  ...
                  child: Row(
                    children: [
                      GestureDetector(
                        onTap: () {
                          Messanger(
                            personconnected: list_of_people[index],
                          );
                        },
