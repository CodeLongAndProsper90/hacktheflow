        ...
        children: [
          SizedBox(
            ...
            child: Card(
              ...
              child: ListView.builder(itemCount: person_connections[personconnected.toString()]?.length, 
              itemBuilder: (BuildContext context, int index) 
                { SizedBox(
                    width:  MediaQuery.of(context).size.width * .8, height: MediaQuery.of(context).size.height * .33, 
                    child: LogoSmallText(person_connections[personconnected.toString()]![index])
                ); 
 return null;},
              ),
              ),
          ...
          SizedBox(
            ...
            width: MediaQuery.of(context).size.width * 0.9,
            child: Container(
              decoration: const BoxDecoration(color: colorAccent ,borderRadius: BorderRadius.horizontal(left: Radius.elliptical(39, 50), right: Radius.elliptical(39, 50))),
